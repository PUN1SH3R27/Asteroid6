...
drawSprites();
  ...
  stroke("green");
  textFont("Algerian");
text("Asteroids Destroyed: "+ SurvivalTime, width/2-400,height/2-200);
text("Survival Time (Light Years): "+ score,width/2-0,height/2-200)
...
function RighttouchesMoved(){
var RightControl; 
RightControl=createSprite(width/2+200,height/2-40,60,60)
...
LeftControl=CreateSprite(width/2-200,height/2-40,60,60)
}
